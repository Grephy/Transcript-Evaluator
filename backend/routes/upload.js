...
// gpaConverter replaced by aiParser built-in grade conversion
...
router.post("/upload", async (req, res) => {
  ...
  try {
    ...
    if (extractedText) {
      ...
      try {
        // parseWithAI already returns normalized courses with convertedGPA, usGrade, gradeScaleType
        courses = await parseWithAI(extractedText, university);
